...
pipeline {
  agent any
    parameters {
        string(name: 'name_container', defaultValue: 'nginx-Test', description: 'nombre de la imagen')
        string(name: 'name_imagen', defaultValue: 'nginx', description: 'nombre de la imagen')
